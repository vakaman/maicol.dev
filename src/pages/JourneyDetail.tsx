          ...
          {detail ? (
            <div className="animate-fade-in-up">
              <ReactMarkdown
                ...
                components={{
                h1: ({ node, ...props }) => (
                  <h2 className="font-heading text-3xl font-bold tracking-tight text-foreground md:text-4xl" {...props} />
                ),
                h2: ({ node, ...props }) => (
                  <h3 className="font-heading text-2xl font-bold tracking-tight text-foreground md:text-3xl" {...props} />
                ),
                h3: ({ node, ...props }) => (
                  <h4 className="font-heading text-xl font-semibold tracking-tight text-foreground md:text-2xl" {...props} />
                ),
