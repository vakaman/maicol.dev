...
describe("locale routing", () => {
  it("resolves locale-prefixed and default routes", () => {
    ...
    expect(resolveLocaleFromPathname("/journey/masternet-inicio")).toBe("us-en");
    expect(resolveLocaleFromPathname("/pt-br")).toBe("pt-br");
    expect(resolveLocaleFromPathname("/pt-br/journey/masternet-inicio")).toBe("pt-br");
  });
  ...
  it("builds locale-aware URLs without duplicating prefixes", () => {
    ...
    expect(getLocalizedPath("pt-br", "/journey/masternet-inicio")).toBe("/pt-br/journey/masternet-inicio");
    expect(getLocalizedPath("us-en", "/pt-br/journey/masternet-inicio")).toBe("/journey/masternet-inicio");
    expect(stripLocalePrefix("/pt-br/journey/masternet-inicio")).toBe("/journey/masternet-inicio");
  });
});
...
describe("seo metadata", () => {
  ...
  it("builds article metadata for journey detail pages", () => {
    const metadata = getJourneyMetadata("us-en", "masternet-inicio");

    expect(metadata).not.toBeNull();
    expect(metadata?.title).toBe("Masternet Telecom | maicol.dev");
    expect(metadata?.canonical).toBe("https://maicol.dev/journey/masternet-inicio");
